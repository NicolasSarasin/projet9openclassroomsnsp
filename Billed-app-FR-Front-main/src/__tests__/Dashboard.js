...
describe("Given I am connected as an Admin", () => {
  describe('When I am on Dashboard page and I click on arrow', () => {
    test('Then I click on arrow', async () => {
      Object.defineProperty(
        window,
        'localStorage',
        { value: localStorageMock }
      ...
      /*const statusContainer = document.getElementById('status-bills-container');
      statusContainer.html("");
      dashboard.counter++;*/
      expect(icon1.style.transform).toEqual('rotate(90deg)');
      expect(icon2.style.transform).toEqual('rotate(90deg)');
      expect(icon3.style.transform).toEqual('rotate(90deg)');
    })
  })
})
